...
import { STAGE_META, STAGE_GROUPS as GROUPS, STAGE_EDGES as EDGES, stripHtml } from "@/lib/pipelineStages";

export function ValueBlock({ value }: { value: Record<string, unknown> | string | undefined }) {

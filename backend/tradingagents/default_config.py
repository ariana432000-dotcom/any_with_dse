...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    "data_vendors": {
        ...
        "fundamental_data": "yfinance",      # Options: alpha_vantage, yfinance, dse (for DSE/Bangladesh tickers)
        "news_data": "yfinance",             # Options: alpha_vantage, yfinance, dse (for DSE/Bangladesh tickers)
